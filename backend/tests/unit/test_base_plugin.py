...
class ConcreteModelImplementation(ModelImplementation):
    ...
    def train(self, train_data: Any) -> TrainingResult:
        return TrainingResult(metrics={"loss": 0.1}, artifact_path="/tmp", training_duration_seconds=1.0)
    ...
    def evaluate(self, evaluation_data: Any) -> EvaluationResult:
        return EvaluationResult(metrics={"accuracy": 0.9}, num_samples=100, evaluation_duration_seconds=0.5)
